...
const SHORT_HOP_IASA = 999
const SHORT_HOP_COMBO_IASA = 999
const FULL_HOP_IASA = 999
...
func _frame_0():
	...
	if not super_jump:
		if squat:
			interrupt_frames[0] = 999
			interrupt_frames[1] = 999
		elif full_hop:
			interrupt_frames[0] = 999
			interrupt_frames[1] = 999
		else :
